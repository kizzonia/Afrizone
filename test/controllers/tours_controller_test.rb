...
class ToursControllerTest < ActionController::TestCase
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post :create, tour: { artist: @tour.artist, date: @tour.date, place: @tour.place, timimg: @tour.timimg, title: @tour.title }
    end
  ...
  test "should update tour" do
    patch :update, id: @tour, tour: { artist: @tour.artist, date: @tour.date, place: @tour.place, timimg: @tour.timimg, title: @tour.title }
    assert_redirected_to tour_path(assigns(:tour))
  end
